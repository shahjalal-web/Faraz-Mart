...
export const ADMIN_NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    ...
    enabled: false,
    items: [
      { label: "All Orders", href: "/admin/orders", enabled: false },
      { label: "Pending", href: "/admin/orders?status=pending", enabled: false },
      { label: "Processing", href: "/admin/orders?status=processing", enabled: false },
      { label: "Shipped", href: "/admin/orders?status=shipped", enabled: false },
      { label: "Delivered", href: "/admin/orders?status=delivered", enabled: false },
      { label: "Cancelled", href: "/admin/orders?status=cancelled", enabled: false },
      { label: "Returns", href: "/admin/orders?status=returned", enabled: false },
    ],
  },
  {
    label: "Customers",
